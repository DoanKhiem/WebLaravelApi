...
<html>
<head>
    <title>GOLDEN STAR LOAN AGREEMENT</title>
    <meta charset="utf-8">
...
<style>
    ...
    .container {width: 1024px; margin: auto; padding-left: 15px; padding-right: 15px;}
    ...
    .form-section .grid-columns content{
        display: grid;
    ...
    .sign-section .sign-parts {
        border: 1px solid #000;
        padding: 1rem;
        min-height: 250px;
    }
    .sign-section .sign-parts .sign-line {
        border-bottom: 1px solid #000;
        margin-top: 10rem;
    }
    .sign-section .sign-parts .name-info {
        margin-top: 2rem;
    }
    .sign-section .sign-parts h1 {
        font-size: 18px;
    }
    .sign-section .sign-parts p {
        font-size: 12px;
        font-weight: 700;
    }
